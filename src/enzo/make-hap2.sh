...
make machine-hap2
make io-64 precision-64 integers-32 particle-id-128 max-baryons-60 max-particle-attr-40 lcaperf-no max-tasks-per-node-64 grackle-yes photon-yes opt-aggressive 
make cuda-yes
#make uuid-no 
