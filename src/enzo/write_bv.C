...
/*
  fprintf(stderr, "wbv field = %"ISYM"\n", field);
  fprintf(stderr, "wbv dim = %"ISYM"\n", dim);
  fprintf(stderr, "wbv face = %"ISYM"\n", face);
  fprintf(stderr, "wbv slabsize = %"ISYM"\n", slabsize);
  fprintf(stderr, "wbv BDims = %"ISYM" %"ISYM" %"ISYM"\n", BoundaryDimension[0], BoundaryDimension[1], BoundaryDimension[2]);
  fprintf(stderr, "wbv BRank = %"ISYM"\n", BoundaryRank);
  fprintf(stderr, "wbv NBF = %"ISYM"\n", NumberOfBaryonFields);
  fprintf(stderr, "wbv cubesize = %"ISYM"\n", cubesize);
  fprintf(stderr, "wbv facesize = %"ISYM"\n", facesize);
  fprintf(stderr, "wbv MaxFaceSize = %"ISYM"\n", MaxFaceSize);
*/
...
// 4D array for file, or 2?
  ...
  h5_status = H5Dwrite(dset_id, mem_type_id, mem_dsp_id, file_dsp_id,  H5P_DEFAULT, bv_buffer);
