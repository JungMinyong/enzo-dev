...
make precision-64 integers-32 particle-id-32 max-baryons-30 opt-aggressive lcaperf-no max-tasks-per-node-36 grackle-yes new-problem-types-yes individualstar-yes new-yield-tables-yes nbody-yes photon-yes cuda-no uuid-no fewbody-yes sevn-no
make show-config
make show-flags
make -j8
