...
#make io-64 precision-64 integers-32 particle-id-128 max-baryons-70 max-particle-attr-60 lcaperf-no max-tasks-per-node-64 grackle-yes photon-yes opt-debug cuda-no uuid-no individualstar-yes new-yield-tables-yes sevn-no memorypool-yes nbody-yes fewbody-no new-problem-types-yes
make io-64 precision-64 integers-32 particle-id-128 max-baryons-70 max-particle-attr-60 lcaperf-no max-tasks-per-node-64 grackle-yes photon-yes opt-aggressive cuda-no uuid-no individualstar-yes new-yield-tables-yes sevn-no memorypool-yes nbody-yes fewbody-no new-problem-types-yes
